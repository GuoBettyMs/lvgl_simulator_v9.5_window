...
SDL2
安装包：https://www.libsdl.org/release/  ->  SDL2-devel-2.30.2-mingw.tar.gz
...
验证：
编译时版本 2.30.2，路径： C:/mingw64/include/SDL2/SDL_version.h
运行时版本 2.30.2.0，路径： C:/mingw64/bin, 右键点击 SDL2.dll，选择"属性",切换到 "详细信息" 选项卡，查看 "文件版本"
